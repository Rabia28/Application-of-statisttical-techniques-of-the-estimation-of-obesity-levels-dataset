...
x = model.matrix(log.model.noWH, df)[,-1] #[-1] means no intercept

y = df$bmi

# The model.matrix() function is particularly useful for creating x; not only does it produce a matrix 
# corresponding to all the predictors but it also automatically transforms any qualitative
