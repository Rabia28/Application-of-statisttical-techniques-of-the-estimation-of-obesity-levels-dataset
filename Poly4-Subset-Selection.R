...
which.min(regfit.fwd.summary$rss) # identify the location of the minimum in the model with 39 predictors
which.max(regfit.fwd.summary$adjr2) # Adjusted R2 is max in the model with 31 predictors
