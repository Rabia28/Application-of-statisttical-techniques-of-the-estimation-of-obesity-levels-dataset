...
x = model.matrix(poly3.model.noWH, df)[,-1] #[-1] means no intercept

y = df$bmi

# The model.matrix() function is particularly useful for creating x; not only does it produce a matrix 
# corresponding to the 34 predictors but it also automatically transforms any qualitative
...
mean((ridge.pred-y.test)^2) # 66.26359 like intercept only
